...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.cxic.service.impl.PasswordTokenManager#generateRecoveryToken(com.cxic.model.User)
     */
    @Override
    ...
    /**
     * @see com.cxic.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.cxic.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.cxic.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
